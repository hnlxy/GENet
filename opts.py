...
# Thank the paper "TSM: Temporal Shift Module for Efficient Video Understanding" for the base codes
...
# ========================= Model Configs ==========================
parser.add_argument('--model', type=str, default="C2D")
parser.add_argument('--arch', type=str, default="resnet50")
parser.add_argument('--num_segments', type=int, default=3)
parser.add_argument('--test_segments', type=str, default="8")
parser.add_argument('--test_crops', type=int, default=1)
parser.add_argument('--test_nets', type=str, default="M4")
parser.add_argument('--test_weights', type=str, default="checkpoint/TSN_M4_resnet50_somethingv1_RGB_avg_segment8_e50_s20p40_ef4_drp5_lr0025_b8_npb_eflr5_280923h00/ckpt.best.pth.tar")
...
parser.add_argument('--element_filter', default=False, action="store_true", help='add element filter block')
parser.add_argument('--cdiv', type=int, default=2)
# --------
...
parser.add_argument('--stage', type=str, default="S3B")
parser.add_argument('--net', type=str, default="L33D")
