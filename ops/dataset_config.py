...
"""
""" BASKETBALL """
ROOT_DATASET = "C:\\Files\\datasets\\"
ROOT_DATASET2 = "E:\\Projects\\datasets\\"
...
def return_ucf101(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET
        filename_imglist_train = root_data + 'ucf101\\splits\\ucf101_train_videofolder3.txt'
        filename_imglist_val   = root_data + 'ucf101\\splits\\ucf101_train_videofolder3.txt'
        prefix = '{:06d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_hmdb51(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET
        filename_imglist_train = root_data + 'hmdb51\\splits\\hmdb51_train_videofolder3.txt'
        filename_imglist_val = root_data + 'hmdb51\\splits\\hmdb51_val_videofolder3.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
...
def return_somethingv1(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET
        filename_imglist_train = root_data + 'something_something_v1\\splits\\sthv1_train_videofolder.txt'
        filename_imglist_val = root_data + 'something_something_v1\\splits\\sthv1_val_videofolder.txt'
        prefix = '{:05d}.jpg'
    # elif modality == 'Flow':
...
def return_somethingv2(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET
        filename_imglist_train = root_data+ 'something_something_v2\\splits\\sthv2_train_videofolder.txt'
        filename_imglist_val = root_data+ 'something_something_v2\\splits\\sthv2_val_videofolder.txt'
        prefix = '{:06d}.jpg'
    # elif modality == 'Flow':
...
def return_jester(modality):
    filename_categories = 'jester\\jester_v1_labels.csv'
    if modality == 'RGB':
        prefix = '{:05d}.jpg'
        root_data = ROOT_DATASET2
        filename_imglist_train = root_data + 'jester\\train_list.txt'
        filename_imglist_val = root_data + 'jester\\val_list.txt'
    else:
        raise NotImplementedError('no such modality:'+modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET
        filename_imglist_train = root_data + 'kinetics400\\splits\\train_list_videos.txt'
        filename_imglist_val = root_data + 'kinetics400\\splits\\val_list_videos.txt'
        prefix = '{:06d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    ...
    if isinstance(file_categories, str):
        file_categories = os.path.join(ROOT_DATASET2, file_categories)
